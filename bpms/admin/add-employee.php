...
$details=$_POST['details'];
    ...
    $query=mysqli_query($con, "insert into  tblemployees(Name,Email,Mobile,Gender,shift) value('$name','$email','$mobilenum','$gender','$details')");
    if ($query) {
...
<html>
<head>
<title>Gayatri Beauty Parlour | Add Services</title>
							 ...
							 <div class="radio">
                               ...
                               <p style="padding-top: 20px; font-size: 15px"> <strong>Gender:</strong> <label>
                                ...
                                <label>
								 ...
								 <label for="cars">Choose shift:</label>
